...
const ManageCandidate = () => {
    ...
    const postingOptions = [
        ...
        ...[...new Set(applications?.map(application => application?.posting?.id))]
            .map(id => {
    ...
    const filteredApplications = applications?.filter(app => {
        ...
        const isPostingMatch = filterPosting ? (filterPosting === "null" ? true : app.posting?.id === filterPosting) : true;
