...
const ManageCandidate = () => {
    ...
    const statusMenu = (applicationId) => (
        <Menu>
            <Menu.Item onClick={() => handApproved(applicationId)}>
                Approve
            </Menu.Item>
            <Menu.Item onClick={() => handRejected(applicationId)}>
                Reject
            </Menu.Item>
        </Menu>
    );
                    ...
                    <tr key={application?.id}>
                        ...
                        <td style={{ textAlign: "center", verticalAlign: "middle" }}>
                            {application?.status === "PENDING" ? (
                                ...
                                <button
                                    className={`status-button ${application?.status === "APPROVED" ? 'active' : 'deactive'}`}
