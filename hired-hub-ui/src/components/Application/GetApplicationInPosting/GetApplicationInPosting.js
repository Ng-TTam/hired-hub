...
import '../GetApplication/GetApplication.scss';
import { fetchApplicationInPosting } from '../../../redux/applicationSlice';
import { Link, useParams } from 'react-router-dom';

const GetApplicationInPosting = () => {
    ...
    useEffect(() => {
        dispatch(fetchApplicationInPosting(postingId));
    }, [dispatch, postingId]);
...
export default GetApplicationInPosting;
