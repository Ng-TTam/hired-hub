...
public enum ErrorCode {
    ...
    USER_DEACTIVATE("ERROR_USER_003", "User is DEACTIVATE status", HttpStatus.BAD_REQUEST),
    ...
    ACCOUNT_NOT_AVAILABLE("ACCOUNT_666", "Account is not available", HttpStatus.UNAUTHORIZED);
